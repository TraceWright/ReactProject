...
const menuStyle = { display: 'inline-block', margin: '16px 32px 16px 0', paddingTop: '50px' };
const menuItemStyle = { textAlign: 'left', paddingLeft: '20px' }
        ...
        <MuiThemeProvider>
          <Router>
            <div>
              ...
              </Drawer>             {/* <Route exact path="/" component={Home}/> */}
